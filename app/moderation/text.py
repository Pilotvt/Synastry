...
from better_profanity.utils import ALLOWED_CHARACTERS, any_next_words_form_swear_word, get_replacement_for_swear_word
...
def _censor_with_matches(
    ...
    censor_wordset = set(word.lower() for word in detector.CENSOR_WORDSET)
